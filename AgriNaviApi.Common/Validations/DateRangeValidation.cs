...
namespace AgriNaviApi.Common.Validations
{
    /// <summary>
    /// 開始日が終了日以降であることをチェック
    /// </summary>
    ...
    public class DateRangeValidation : ValidationAttribute
    {
        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                return new ValidationResult($"{CommonValidationMessages.propertyNameMessage}: {_startDatePropertyName} または {_endDatePropertyName}");
            }

...
namespace AgriNaviApi.Shared.Exceptions
{
    ...
    /// </summary>
    /// <remarks>
    /// ハッシュ値のパスワードに関する例外を明示することが目的のため、特に処理は無し
    /// </remarks>
    [Serializable]
    public class PasswordHashingException : Exception, ILocalizedException
    {
        /// <summary>
        /// どのresxファイルを使うかを登録
        /// </summary>
        ...
        public PasswordHashingException(Type resourceType, string resourceKey, params object[] args) : base()
        {
        ...
        protected PasswordHashingException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            // カスタムプロパティの復元

...
namespace AgriNaviApi.Shared.Exceptions
{
    ...
    /// </remarks>
    [Serializable]
    public class DuplicateEntityException : Exception, ILocalizedException
    {
        /// <summary>
        /// どのresxファイルを使うかを登録
        /// </summary>
        public Type ResourceType { get; } = null!;
        ...
        public DuplicateEntityException(Type resourceType, string resourceKey, params object[] args) : base()
        {

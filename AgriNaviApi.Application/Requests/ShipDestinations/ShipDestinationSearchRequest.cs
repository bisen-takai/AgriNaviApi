...
namespace AgriNaviApi.Application.Requests.ShipDestinations
{
    ...
    /// 出荷先検索時のリクエスト
    /// </summary>
    public class ShipDestinationSearchRequest
    {
        /// <summary>
        /// 検索名
        /// </summary>
        ...
        /// </summary>
        [Display(Name = "ソートキー")]
        [EnumDataType(typeof(ShipDestinationSortKey), ErrorMessageResourceName = nameof(CommonValidationMessages.EnumSortKeyMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]
        public ShipDestinationSortKey? SortBy { get; set; }

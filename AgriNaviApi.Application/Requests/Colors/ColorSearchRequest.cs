...
namespace AgriNaviApi.Application.Requests.Colors
{
    ...
    public class ColorSearchRequest
    {
        ...
        /// </summary>
        [Display(Name = "ソートキー")]
        [EnumDataType(typeof(ColorSortKey), ErrorMessageResourceName = nameof(CommonValidationMessages.EnumSortKeyMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]
        public ColorSortKey? SortBy { get; set; }

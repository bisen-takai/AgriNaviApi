...
namespace AgriNaviApi.Application.Requests.QualityStandards
{
    ...
    public class QualityStandardSearchRequest
    {
        ...
        /// </summary>
        [Display(Name = "ソートキー")]
        [EnumDataType(typeof(QualityStandardSortKey), ErrorMessageResourceName = nameof(CommonValidationMessages.EnumSortKeyMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]
        public QualityStandardSortKey? SortBy { get; set; }

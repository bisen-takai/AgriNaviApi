...
{
    public class ShipmentLineWithUuidRequest : IShipmentLineForeignKeys
    {
        /// <summary>
        /// 出荷記録詳細UUID
        /// </summary>
        [Display(Name = "出荷記録詳細UUID")]
        [NotEmptyGuid(ErrorMessage = nameof(CommonValidationMessages.RequiredMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]

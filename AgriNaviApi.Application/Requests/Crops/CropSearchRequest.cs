...
namespace AgriNaviApi.Application.Requests.Crops
{
    ...
    public class CropSearchRequest
    {
        ...
        /// </summary>
        [Display(Name = "ソートキー")]
        [EnumDataType(typeof(CropSortKey), ErrorMessageResourceName = nameof(CommonValidationMessages.EnumSortKeyMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]
        public CropSortKey? SortBy { get; set; }

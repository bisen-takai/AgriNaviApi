...
namespace AgriNaviApi.Application.Requests.Units
{
    ...
    public class UnitSearchRequest
    {
        ...
        /// </summary>
        [Display(Name = "ソートキー")]
        [EnumDataType(typeof(UnitSortKey), ErrorMessageResourceName = nameof(CommonValidationMessages.EnumSortKeyMessage), ErrorMessageResourceType = typeof(CommonValidationMessages))]
        public UnitSortKey? SortBy { get; set; }
